...
export const AUTOPILOT_STEPS: AutopilotStepInfo[] = [
  ...
  },
  {
    ...
    badge: "Paso 2 de 9 · Horario del Alumno",
    route: "/admin/alumnos",
  ...
  {
    id: 7,
    title: "Reporte Maestro de Alumnos y Clientes",
    badge: "Paso 7 de 9 · Reportes",
    route: "/admin/reportes",
    summary: "Lista enumerada 1 a N de alumnos, control de morosidad, horarios, asistencia consolidada y descarga oficial en Excel.",
  },
  {
    id: 8,
    title: "Clases Demo de Claudia y Matrícula Oficial",
    badge: "Paso 8 de 9 · Clases Demo",
    route: "/admin/demos",
    summary: "Prospectos exclusivos para clases demo con la Directora Claudia (a partir de las 4pm) y pase directo a alumno activo en 1 clic.",
  },
  {
    id: 9,
    title: "Accesos WhatsApp y Asistencia Docente en Sede",
    badge: "Paso 9 de 9 · Sede y Docentes",
    route: "/admin",
