...
export const AUTOPILOT_STEPS: AutopilotStepInfo[] = [
  {
    ...
    badge: "Paso 1 de 6 · Directorio",
    route: "/admin/alumnos",
    summary: "Obligatorio registrar a Papá, Mamá y Contacto de Emergencia con teléfonos para evitar llamadas perdidas.",
  },
  {
    id: 2,
    title: "Horarios Pareados y Aforo Máximo",
    badge: "Paso 2 de 6 · Horario",
    route: "/admin/agenda",
    summary: "Plan Regular de 2 clases semanales: Lunes jala Miércoles (o Martes jala Jueves). Límite estricto: 5 alumnos.",
  },
  {
    id: 3,
    title: "Asistencia en Kardex y Justificaciones",
    badge: "Paso 3 de 6 · Asistencia",
    route: "/admin/alumnos",
  ...
  },
  {
    ...
    badge: "Paso 6 de 6 · Sede y Docentes",
    route: "/admin",
