...
export const officialControlPagosStudents: ControlPagosStudentWithAnnual[] = [
  {
    ...
    "recentAttendance": ["presente", "presente", "presente", "presente", "presente", "presente"],
    "teacherNote": "Ex-alumno de Alex. Paquete Flexible 24 clases a demanda por S/ 500 pagado el 20/08/2026. Vigencia por clases terminadas.",
...
export const officialControlPagosInvoices: Invoice[] = [
  {
    ...
    "phone": "962386336",
    "concept": "Paquete Especial 24 clases a demanda (Canto) — Ex-alumno",
    "amount": 500,
    "amountPaid": 500,
    "remainingBalance": 0,
    "dueDate": "2026-08-20",
