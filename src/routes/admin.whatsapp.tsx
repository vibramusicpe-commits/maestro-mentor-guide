...
export function AdminWhatsAppPage() {
  ...
  return (
    <div className="min-h-screen text-foreground space-y-6">
      {/* ============================================================== */}
      {/* HEADER PRINCIPAL */}
      {/* ============================================================== */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-5">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <RefreshCw className="w-3.5 h-3.5 mr-1.5 text-[#F47B20]" />
            Sincronizar
          </Button>
      ...
      <div className="flex items-center gap-2 border-b border-border overflow-x-auto pb-px">
        ...
        >
          ...
          {conversations.filter((c) => c.status_badge === "Requiere asesor").length > 0 && (
            <span className="ml-1 px-1.5 py-0.2 rounded-full text-[10px] bg-amber-500/20 text-amber-600 dark:text-amber-300 font-bold border border-amber-500/40">
        ...
        >
          ...
          Citas y Ventas
          <span className="ml-1 px-1.5 py-0.2 rounded-full text-[10px] bg-orange-500/20 text-[#F47B20] font-bold border border-orange-500/30">
            {leads.length}
          </span>
        </button>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-card rounded-2xl p-5 border border-border shadow-xs relative overflow-hidden">
              <div className="text-[11px] font-bold tracking-wider text-muted-foreground uppercase mb-3 flex items-center gap-1.5">
                <Phone className="w-3.5 h-3.5 text-[#F47B20]" />
                Estado de Conexión
              </div>

              <div className="flex items-start gap-3 mt-2">
                <div className="w-9 h-9 rounded-full bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center shrink-0 text-emerald-500">
                ...
                <div>
                  ...
                  <div className="text-lg font-black text-foreground tracking-wide mt-0.5 font-mono">
            ...
            <div className="bg-card rounded-2xl p-5 border border-border space-y-4">
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <span className="text-[11px] text-muted-foreground">{agentName.length}/50</span>
                </div>
                <Input
                  value={agentName}
                  maxLength={50}
                  onChange={(e) => setAgentName(e.target.value)}
                  className="bg-background border-border focus:border-[#F47B20] text-sm text-foreground"
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <span className="text-[11px] text-muted-foreground">{initialGreeting.length}/500</span>
                </div>
                <textarea
                  rows={4}
                  maxLength={500}
                  ...
                  className="w-full bg-background border border-border focus:border-[#F47B20] rounded-xl p-3 text-xs text-foreground resize-none outline-none focus:ring-1 focus:ring-[#F47B20]"
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <span className="text-[11px] text-muted-foreground">{businessContext.length}/2000</span>
                </div>
                <textarea
                  rows={7}
                  maxLength={2000}
                  ...
                  className="w-full bg-background border border-border focus:border-[#F47B20] rounded-xl p-3 text-xs text-foreground resize-none outline-none focus:ring-1 focus:ring-[#F47B20] leading-relaxed"
          ...
          <div className="bg-card rounded-2xl p-5 border border-border flex flex-col justify-between space-y-4">
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Button
                  ...
                  className="h-7 px-2 text-[11px] text-[#F47B20] hover:text-[#FF9E3D] hover:bg-orange-500/10"
                >
              ...
              <div className="space-y-2.5 max-h-[580px] overflow-y-auto pr-1">
                {botShortcuts.map((sc, idx) => (
                  <div
                    key={sc.command}
                    className="bg-background border border-border rounded-xl p-3 flex items-center justify-between gap-3 hover:border-[#F47B20]/50 transition-colors"
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-bold text-[#F47B20] tracking-wide font-mono">
                          {sc.command}
                        </span>
                      </div>
                      <p className="text-[11px] text-muted-foreground truncate mt-0.5">{sc.title}</p>
                    </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <Button
                        ...
                        className="h-7 px-2 text-[10px] text-muted-foreground hover:text-foreground bg-muted/60 hover:bg-muted rounded-md"
                      >
                        Editar
                      </Button>
                      <Switch
                        ...
                        className="data-[state=checked]:bg-[#F47B20]"
                      />
                    </div>
                  </div>
                ))}
            ...
            {/* Info Box Inferior */}
            <div className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-center gap-2.5 text-[11px] text-amber-600 dark:text-amber-300">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="bg-background border-border pl-8 pr-3 text-xs text-foreground h-9 rounded-xl"
                />
              </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex items-center gap-2.5 min-w-0">
                          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#F47B20] to-[#FF9E3D] text-[#0D0B0A] font-bold text-[11px] flex items-center justify-center shrink-0">
                      ...
                      <p className="text-[11px] text-muted-foreground truncate mt-2 leading-relaxed">
                        {c.last_message}
                      </p>
                    </div>
                  );
          ...
          {/* ------------------------------------------------------------ */}
          <div className="bg-card rounded-2xl border border-border flex flex-col justify-between overflow-hidden shadow-xs">
            {/* Header del Chat */}
            {currentConversation ? (
              <div className="p-4 border-b border-border bg-muted/30 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-emerald-500 flex items-center justify-center font-bold text-xs">
                ...
                <div className="flex items-center gap-1.5">
                  {currentConversation.status_badge === "Requiere asesor" ? (
                    <Button
                      ...
                      className="h-7 text-[10px] border-emerald-500/30 text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 hover:bg-emerald-500/20"
                    >
                    ...
                    <Button
                      ...
                      className="h-7 text-[10px] border-amber-500/30 text-amber-600 dark:text-amber-300 bg-amber-500/10 hover:bg-amber-500/20"
                    >
            ...
            {/* Cuerpo de Mensajes */}
            <div className="flex-1 p-4 space-y-3 overflow-y-auto max-h-[500px] bg-background/70">
              <div className="flex justify-center my-2">
                <span className="text-[10px] bg-muted text-muted-foreground px-2.5 py-0.5 rounded-full border border-border">
                  Hoy
                </span>
              </div>
                  ...
                  >
                    <div
                      className={`max-w-[85%] rounded-2xl p-3 text-xs shadow-xs ${
                        isInbound
                          ? "bg-muted/70 text-foreground border border-border rounded-tl-xs"
                          : "bg-gradient-to-br from-amber-500/10 to-orange-500/20 dark:from-amber-950/70 dark:to-orange-950/80 border border-[#F47B20]/40 text-foreground rounded-tr-xs"
                      }`}
                    >
                      ...
                      <div className="flex items-center justify-end gap-1 mt-1.5 text-[9px] text-muted-foreground">
                        ...
                        {!isInbound && <CheckCheck className="w-3 h-3 text-[#F47B20]" />}
                      </div>
                    </div>
                  </div>
                );
            ...
            <div className="p-3 bg-card border-t border-border flex items-center gap-2">
              <Input
                ...
                className="bg-background border-border text-xs text-foreground focus:border-[#F47B20] h-10 rounded-xl"
              />
              <Button
                onClick={handleSendManualReply}
                disabled={isSendingMessage || !replyText.trim()}
                className="h-10 px-3 bg-gradient-to-r from-[#F47B20] to-[#FF9E3D] text-[#0D0B0A] rounded-xl shrink-0 cursor-pointer font-bold"
              >
      ...
      {activeTab === "reglas" && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-card rounded-2xl p-6 border border-border space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wider text-foreground flex items-center gap-2 font-display">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              cambiando el estado a <code className="text-[#F47B20] bg-orange-500/10 px-1 py-0.5 rounded font-mono">requiere_asesor</code>.
            </p>
            ...
            <div className="space-y-2">
              {[
                ...
                <div
                  key={r.tag}
                  className="bg-background p-3 rounded-xl border border-border flex items-center justify-between"
                >
                  <div>
                    <span className="text-xs font-mono font-bold text-[#F47B20]">"{r.tag}"</span>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="bg-background p-3 rounded-xl border border-border flex justify-between items-center">
                <span className="text-muted-foreground">Modelo LLM (Env Var):</span>
                <span className="font-mono text-foreground font-bold">GEMINI_MODEL_ID (gemini-3.1-flash-lite)</span>
              </div>
              <div className="bg-background p-3 rounded-xl border border-border flex justify-between items-center">
                <span className="text-muted-foreground">Temperature:</span>
                <span className="font-mono text-foreground font-bold">0.2 (Determinista)</span>
              </div>
              <div className="bg-background p-3 rounded-xl border border-border flex justify-between items-center">
                <span className="text-muted-foreground">Tool Choice:</span>
                <span className="font-mono text-emerald-600 dark:text-emerald-400 font-bold">mode: "ANY" (Forzado en acción)</span>
              </div>
              <div className="bg-background p-3 rounded-xl border border-border flex justify-between items-center">
                <span className="text-muted-foreground">Memoria Efímera:</span>
                <span className="font-mono text-foreground font-bold">Últimos 6 turnos (Upstash Redis)</span>
              </div>
              <div className="bg-background p-3 rounded-xl border border-border flex justify-between items-center">
                <span className="text-muted-foreground">Fuente de Verdad:</span>
                <span className="font-mono text-[#F47B20] font-bold">PostgreSQL en Insforge</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border space-y-4">
            ...
            <div className="space-y-2 text-xs">
              <div className="bg-background p-3 rounded-xl border border-border">
                <div className="font-bold text-foreground">Lunes a Viernes</div>
                <div className="text-muted-foreground mt-0.5">3:00 p.m. a 9:00 p.m. (Bloques de 45 min)</div>
              </div>
              <div className="bg-background p-3 rounded-xl border border-border">
                <div className="font-bold text-foreground">Sábados</div>
                <div className="text-muted-foreground mt-0.5">8:00 a.m. a 2:00 p.m. y 2:00 p.m. a 6:00 p.m.</div>
              </div>
              <div className="bg-background p-3 rounded-xl border border-border">
                <div className="font-bold text-foreground">Domingos</div>
                <div className="text-muted-foreground mt-0.5">Cerrado (Solo respuestas automáticas del bot)</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-border/60">
                {filteredConversations.map((c) => (
                  <tr key={c.phone} className="hover:bg-muted/30 transition-colors">
                    <td className="py-3 px-4 font-bold text-foreground">{c.sender_name}</td>
                    <td className="py-3 px-4 font-mono text-muted-foreground">{c.phone}</td>
                    <td className="py-3 px-4 text-foreground max-w-xs truncate">{c.last_message}</td>
                    ...
                    <td className="py-3 px-4 text-right">
                      <Button
                        ...
                        className="h-7 text-[11px] text-[#F47B20] hover:text-[#FF9E3D] hover:bg-orange-500/10"
                      >
                        Abrir Chat
                      </Button>
                    </td>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-card p-5 rounded-2xl border border-border shadow-xs">
              ...
              <div className="text-3xl font-black text-foreground mt-1 font-display">{leadMetrics.total}</div>
              <div className="text-[11px] text-muted-foreground mt-1">WhatsApp & Facebook Ads</div>
            </div>
            ...
            <div className="bg-card p-5 rounded-2xl border border-border shadow-xs">
              ...
              <div className="text-3xl font-black text-[#F47B20] mt-1 font-display">
                {leadMetrics.agendadas}
              </div>
              <div className="text-[11px] text-muted-foreground mt-1">Confirmadas o en proceso</div>
            </div>
            ...
            <div className="bg-card p-5 rounded-2xl border border-border shadow-xs">
              ...
              <div className="text-3xl font-black text-emerald-600 dark:text-emerald-400 mt-1 font-display">
                {leadMetrics.matriculados}
              </div>
              <div className="text-[11px] text-muted-foreground mt-1 font-medium">
                Tasa de Cierre: <span className="text-foreground font-bold">{leadMetrics.conversionRate}%</span>
              </div>
            </div>
            ...
            <div className="bg-card p-5 rounded-2xl border border-border shadow-xs">
              ...
              <div className="text-3xl font-black text-amber-500 mt-1 font-display">
                {leadMetrics.requierenAsesor}
              </div>
              <div className="text-[11px] text-muted-foreground mt-1">Atención personalizada</div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border space-y-4 shadow-xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Registros en la tabla <code className="text-[#F47B20] font-mono">demo_requests</code> de Insforge.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <select
                  ...
                  className="bg-background border border-border text-xs text-foreground rounded-xl h-9 px-3 outline-none"
                >
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-[#F47B20] to-[#FF9E3D] text-[#0D0B0A] font-extrabold text-xs h-9 rounded-xl shadow-xs"
                >
                ...
                <tbody className="divide-y divide-border/60">
                  {filteredLeads.map((lead) => (
                    <tr key={lead.id} className="hover:bg-muted/30 transition-colors">
                      <td className="py-3 px-4">
                        <div className="font-bold text-foreground">{lead.parent_name}</div>
                        <a
                      ...
                      <td className="py-3 px-4 text-foreground font-medium">{lead.student_name}</td>

                      <td className="py-3 px-4">
                        <span className="px-2.5 py-1 rounded-md bg-orange-500/10 text-[#F47B20] dark:text-[#FF9E3D] border border-orange-500/30 text-[10px] font-semibold">
                          {lead.instrument}
                        </span>
                      </td>
                      ...
                      <td className="py-3 px-4 text-muted-foreground">
                        {lead.preferred_date ? (
                          ...
                          <span className="text-muted-foreground italic">Por coordinar</span>
                        )}
                      </td>
                      ...
                      <td className="py-3 px-4">
                        <select
                          ...
                          className="bg-background border border-border text-[11px] rounded-lg px-2 py-1 text-foreground outline-none"
                        >
                          <option value="pendiente">Pendiente</option>
                          <option value="confirmada">Confirmada</option>
                          <option value="asistio">Asistió</option>
                      ...
                      <td className="py-3 px-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Button
                            ...
                            className="h-7 text-[10px] border-orange-500/40 text-[#F47B20] bg-orange-500/10 hover:bg-orange-500/20"
                          >
                          ...
                          <Button
                            ...
                            className="h-7 text-[10px] bg-emerald-600 hover:bg-emerald-700 text-white font-semibold shadow-xs"
                          >
        ...
        <DialogContent className="bg-card border-border text-foreground max-w-md">
          ...
          {editingShortcut && (
            <div className="space-y-4 py-2">
              <div>
                <label className="text-xs font-bold text-muted-foreground uppercase">Comando</label>
                <Input
                  ...
                  placeholder="/precios"
                  className="bg-background border-border text-foreground font-mono text-xs mt-1 rounded-xl"
                />
              </div>

              <div>
                <label className="text-xs font-bold text-muted-foreground uppercase">Título Descriptivo</label>
                <Input
                  ...
                  className="bg-background border-border text-foreground text-xs mt-1 rounded-xl"
                />
              </div>

              <div>
                <label className="text-xs font-bold text-muted-foreground uppercase">Texto de Respuesta</label>
                <textarea
                  rows={5}
                  ...
                  className="w-full bg-background border border-border rounded-xl p-3 text-xs text-foreground resize-none mt-1 outline-none focus:border-[#F47B20]"
                />
              </div>
            </div>
          )}
          ...
          <DialogFooter className="gap-2">
            <Button
              ...
              className="border-border bg-transparent text-foreground text-xs"
            >
              Cancelar
            </Button>
            <Button
              ...
              className="bg-gradient-to-r from-[#F47B20] to-[#FF9E3D] text-[#0D0B0A] font-extrabold text-xs shadow-xs"
            >
              Guardar Atajo
            </Button>
          </DialogFooter>
      ...
      <Dialog open={isNewLeadModalOpen} onOpenChange={setIsNewLeadModalOpen}>
        <DialogContent className="bg-card border-border text-foreground max-w-md">
          <DialogHeader>
            <DialogTitle className="text-base font-bold font-display">
              Registrar Prospecto / Clase Demo
            </DialogTitle>
            <DialogDescription className="text-xs text-muted-foreground">
          ...
          <form onSubmit={handleCreateManualLead} className="space-y-3.5 py-2">
            <div>
              <label className="text-xs font-bold text-muted-foreground uppercase">Nombre del Apoderado *</label>
              <Input
                required
                value={newLeadParent}
            ...
            <div>
              ...
              <Input
                ...
                className="bg-background border-border text-foreground text-xs mt-1 rounded-xl font-mono"
              />
            </div>

            <div>
              <label className="text-xs font-bold text-muted-foreground uppercase">Nombre y Edad del Alumno *</label>
              <Input
                required
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs font-bold text-muted-foreground uppercase">Instrumento</label>
                <select
                  value={newLeadInstrument}
                  onChange={(e) => setNewLeadInstrument(e.target.value)}
                  className="w-full bg-background border border-border text-foreground text-xs rounded-xl h-9 px-2 mt-1 outline-none"
                >
              ...
              <div>
                <label className="text-xs font-bold text-muted-foreground uppercase">Fecha Tentativa</label>
                <Input
                  type="date"
                  value={newLeadDate}
      ...
      >
        <DialogContent className="bg-card border-border text-foreground max-w-md">
          <DialogHeader>
            <DialogTitle className="text-base font-bold flex items-center gap-2 font-display">
              <CreditCard className="w-5 h-5 text-[#F47B20]" />
          ...
          {selectedLeadForPayment && (
            <div className="space-y-4 py-2 text-xs">
              <div className="bg-background p-3 rounded-xl border border-border space-y-1.5">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Apoderado:</span>
                  <span className="font-bold text-foreground">{selectedLeadForPayment.parent_name}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Alumno:</span>
                  <span className="text-foreground">{selectedLeadForPayment.student_name}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Monto Sugerido:</span>
                  <span className="font-bold text-emerald-600 dark:text-emerald-400">S/ 260.00 (Matrícula + 1er Mes)</span>
                </div>
              </div>

              {paymentLinkGenerated && (
                <div className="space-y-2">
                  <label className="text-xs font-bold text-muted-foreground uppercase">Enlace de Pago</label>
                  <div className="flex items-center gap-2">
                    <Input
                      readOnly
                      value={paymentLinkGenerated}
                      className="bg-background border-border font-mono text-[11px] text-foreground"
                    />
                    <Button
                      size="sm"
                      onClick={() => {
                      ...
                      className="bg-gradient-to-r from-[#F47B20] to-[#FF9E3D] text-[#0D0B0A] font-bold shrink-0"
                    >
